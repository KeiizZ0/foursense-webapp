...
export default function AbsencePage() {
  ...
  async function handleAbsen() {
    ...
    try {
      ...
      setAbsenceHistory((prev) => [
        { date: today, status: statusDariApi },
        ...prev,
      ]);
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <button
          ...
          className={`py-2 rounded-xl font-medium ${activeTab === "tasks" ? "bg-white shadow" : "bg-gray-100 text-gray-400"
            }`}
        >
        ...
        <button
          ...
          className={`py-2 rounded-xl font-medium ${activeTab === "absence" ? "bg-white shadow" : "bg-gray-100 text-gray-400"
            }`}
        >
          Absensi
        </button>
      ...
      {showAbsenModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl text-center">
            ...
            <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium mb-4 ${statusAbsenSekarang === "Hadir"
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-white disabled:opacity-50 ${statusAbsenSekarang === "Hadir" ? "bg-green-600" : "bg-yellow-500"
                  }`}
              >
      ...
      {activeTab === "absence" && (
        <div className="space-y-6">
          <div className="border rounded-xl p-6 bg-blue-50">
            ...
            {sudahAbsenHariIni && (
              <div className={`p-3 rounded mb-4 text-sm ${statusHariIni === "Hadir" ? "bg-green-100 text-green-700"
            ...
            {!absenDisabled && (
              <p className={`text-center text-sm mt-3 ${statusAbsenSekarang === "Terlambat" ? "text-yellow-600" : "text-green-600"
                }`}>
                {statusAbsenSekarang === "Terlambat"
