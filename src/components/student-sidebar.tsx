...
import { Check as CheckList, LogOut, BarChart3 } from 'lucide-react'
...
export function StudentSidebar() {
  ...
  const menuItems = [
    ...
    { label: 'Todo List', href: '/student/todos', icon: CheckList },
    { label: 'Absensi', href: '/student/attendance', icon: BarChart3 },
  ]
